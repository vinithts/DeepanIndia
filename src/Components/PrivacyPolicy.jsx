...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Main Content */}
      <main
        className="max-w-5xl mx-auto shadow-lg rounded-lg my-8 overflow-hidden"
        style={{
          padding: "50px",
          color: "#49326b",
          backgroundColor: "#f9f3fe", // Base text color
        }}
      >
        ...
        <div className="p-6 sm:p-8">
          <div className="prose max-w-none">
            ...
            <p className="mb-6 text-gray-700">
              Privacy Policy ("we," "our," or "us") is committed to protecting
              your privacy. This Privacy Policy explains how we collect, use,
              disclose, and safeguard your information when you engage with our
              trading fund services, website, and mobile application.
            </p>
            <p className="mb-6 text-gray-700">
            ...
            <div className="mb-8">
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-4 border-l-4 border-blue-500">
                ...
                <p className="text-gray-700">
                  ...
                  provide when opening an account, including but not limited to
                  your name, email address, phone number, postal address, date
                  of birth, social security number, tax identification number,
                  bank account information, and government-issued
                  identification.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-4 border-l-4 border-blue-500">
                ...
                <p className="text-gray-700">
                  We collect information about your financial status, investment
                  experience, investment objectives, and transaction history to
                  comply with regulatory requirements and to provide appropriate
              ...
              <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-blue-500">
                ...
                <p className="text-gray-700">
                  When you access our platform, we automatically collect device
                  information, log data, and usage information through cookies
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                ...
                <li>
                  Assess your financial needs and provide appropriate investment
                  recommendations
                </li>
                <li>
                  Communicate with you about your account, transactions, and our
                  services
                </li>
                <li>Improve our platform and develop new features</li>
                <li>
                  Detect and prevent fraud, unauthorized activities, and illegal
                  behavior
                </li>
              </ul>
            </div>
            ...
            {/* Contact Us */}
            <div>
              <h3 className="text-xl font-semibold mb-3 mt-3">Contact Us</h3>
